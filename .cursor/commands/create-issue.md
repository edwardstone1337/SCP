...
- Save the final issue as a Markdown file in `issues/` (kebab-case filename)
...
- By default, always save the issue to `issues/<kebab-case-title>.md` unless the user explicitly asks not to